...
void transferir(conta_t *origem, conta_t *destino, double valor) {
    // Logica simples que evitar um deadlock, que consistem emqual mutex travar primeiro, caso o id seja menor
    // que o destino é travado primeiro a origem
    // caso contrario primeiro o destino
    // assim o programa consegue executar por completo sem acontecer mais o deadlock que antes acontecia
