...
/*Anteriormente o palalelismo estava acontecendo de forma errada
estava tendo acessos indevidos (escritas, e acessos de forma incorreta)
que acarreta em uma matriz errada, a solução foi manipular o acesso,
para cada thread acessar apenas uma linha/coluna podendo so escrever na mesma
sem alterar o valor escrito por outra thread*/
